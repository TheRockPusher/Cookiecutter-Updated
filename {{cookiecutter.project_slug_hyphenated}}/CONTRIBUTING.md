...
Thank you for considering contributing to {{cookiecutter.project_name}}! This document provides guidelines and instructions for contributing.
...
git clone https://github.com/YOUR_USERNAME/{{cookiecutter.project_slug_hyphenated}}.git
...
Your contributions make {{cookiecutter.project_name}} better for everyone. We appreciate your time and effort!
